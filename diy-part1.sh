...
#echo 'src-git luci https://github.com/lsydy260806/luci-app-adguardhome.git;main' >>feeds.conf.default
sed -i '1i src-git luci https://github.com/lsydy260806/luci-app-adguardhome.git;main' feeds.conf.default
